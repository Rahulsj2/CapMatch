<template>
    <div class="passwd-email py-5 text-left">
        <div class="">
            ...
            <h4 class="header mb-3 pt-4">Reset your password</h4>
            <p class="desc">Enter your <b class="bold-color">Ashesi email address</b> below and we’ll <br> send you a new verification email </p>
        </div>
        <form id="passwd-email-form" v-on:submit.prevent="submit" class="pb-5 mb-5">
            <div class="row">
                 ...
                 <div class="col-12 form-group py-4">
                   <button class="btn btn-wine btn-lg col-12">Send password reset email</button>
                </div>
            </div>
        </form>
        <div class="onboard-footer text-center">
            <p>Already have an account? <router-link to="/login" class="signin" href="#">Sign in</router-link></p>
        </div>
    </div>
</template>
